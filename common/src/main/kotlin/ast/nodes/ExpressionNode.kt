...
sealed class ExpressionNode : Node() {
    ...
    sealed class IdNode : ExpressionNode() {
        ...
        @Serializable
        data class CreateIdentifierNode(val token: Token, val mutable: Boolean) : IdNode()
    }

    @Serializable
    data class VariableNode(val identifier: IdNode.CreateIdentifierNode, val dataType: TypeNode) : ExpressionNode()
    ...
    @Serializable
    data class ReadEnvNode(val token: Token, val variable: IdNode.IdentifierNode) : ExpressionNode()
