...
sealed class StatementNode : Node() {
    @Serializable
    data class AssignationNode(val identifier: ExpressionNode.IdNode.IdentifierNode,
                               val expression: ExpressionNode) : StatementNode()

    @Serializable
    data class DeclarationAndAssignationNode(val variable: ExpressionNode.VariableNode,
                                             val expression: ExpressionNode) : StatementNode()
